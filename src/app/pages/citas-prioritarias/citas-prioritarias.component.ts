...
import { HabilitarCitasComponent } from '../../shared/componets/dialog/habilitar-citas/habilitar-citas.component';
...
export class CitasPrioritariasComponent {
  ...
  openHabilitarAppointmentDialog() {
    const dialogRef = this.dialog.open(HabilitarCitasComponent, {
      width: '60rem',
      maxHeight: '90vh',
      disableClose: true,
      data: { citas: this.citas },
